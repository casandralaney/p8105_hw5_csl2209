...
As the number of birthdays tested expands, so does the probability of
repetition.
...
```
    ...
    ## 1     4.94      5.27 0.0000120        29     3.02      6.85 One Sam… two.sided
...
The association between effect size and power is a positive, as the true
value of mu increases with the probability of the null being rejected.
...
is approximately equal to the true value of mu, as the two graphs above
are very similar. Both show positive trends with similarly proportional
increases between respective x and y variables.
