...
As the number of birthdays tested expands, so does the probability of repetition.
...
The association between effect size and power is a positive, as the true value of mu increases with the probability of the null being rejected.  
...
The sample average of mu hat across tests for which the null is rejected is approximately equal to the true value of mu, as the two graphs above are very similar. Both show positive trends with similarly proportional increases between respective x and y variables.
